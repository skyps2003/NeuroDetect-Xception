...
import { UploadCloud, Activity, BrainCircuit, Loader2, AlertCircle, RefreshCw } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
          ...
          <div className="flex flex-col h-full">
            <div 
              ...
              onDrop={handleDrop}
              className={`relative flex-1 group border-2 border-dashed rounded-3xl p-8 flex flex-col items-center justify-center transition-all duration-300 min-h-[400px] overflow-hidden ${
                isDragActive ? 'border-medical-indigo bg-medical-indigo/10 scale-[1.01]' : 'border-slate-700 bg-card-bg hover:border-slate-500'
              }`}
            >
                  ...
                  <div className="flex gap-4 w-full">
                    ...
                    {!result && (
                      <button 
                        ...
                        disabled={loading}
                        className={`flex-1 py-3 rounded-xl font-semibold flex items-center justify-center text-sm transition-all shadow-lg ${
                          loading 
